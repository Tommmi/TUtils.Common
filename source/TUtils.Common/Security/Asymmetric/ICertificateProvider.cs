...
namespace TUtils.Common.Security.Asymmetric
{
	public interface ICertificateProvider
	{
		...
		IPublicCertificate GetPublicCertificateByFilePath(string filePath, string password);
		...
		/// </param>
		/// <returns></returns>
		IPublicCertificate GetPublicCertificateFromWindowsStorage(string subjectName);
		...
		IPrivateCertificate GetPrivateCertificateByFilePath(string filePath, string password);
		...
		/// </param>
		/// <returns></returns>
		IPrivateCertificate GetPrivateCertificateFromWindowsStorage(string friendlyName);
		...
		/// </param>
		/// <returns></returns>
		IPublicCertContentBase64String CreatePublicCertificateDefinitionByString(string content);
		...
		/// </param>
		/// <returns></returns>
		IPrivateCertContentBase64String CreatePrivateCertificateDefinitionByString(string content);
	}
}
